package com.klxair.ui.view.viewpager.directionalcarousel.fglayout;
...
public class ForegroundRelativeLayout extends RelativeLayout {
	...
	public ForegroundRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		try {
			if (a != null) {
				mForegroundDrawable = a.getDrawable(R.styleable.ForegroundRelativeLayout_android_foreground);
			}
		} finally {
			if (a != null) {
				a.recycle();
