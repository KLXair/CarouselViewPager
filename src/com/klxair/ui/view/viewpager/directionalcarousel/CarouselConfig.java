...
public class CarouselConfig implements Parcelable {
	...
	public static final Parcelable.Creator<CarouselConfig> CREATOR = new Parcelable.Creator<CarouselConfig>() {
		@Override
	...
	public String toString() {
		return "CarouselConfig{" + "bigScale=" + bigScale + ", smallScale=" + smallScale + ", orientation="
				+ orientation + ", infinite=" + infinite + ", scrollScalingMode=" + scrollScalingMode + ", pageMargin="
				+ pageMargin + ", pageLimit=" + pageLimit + ", pagerId=" + pagerId + '}';
	}
}